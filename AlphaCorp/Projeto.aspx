            ...
            <div class="row" style="padding: 20px;">
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        ...
                        <asp:DropDownList ID="ddlDepartamento" AppendDataBoundItems="true" runat="server" class="form-control req">
                            <asp:ListItem Text="Selecione..." Value="0" Selected="True" />
                        </asp:DropDownList>
                    </div>
                    <div class="col-sm-4">
                        <label for="ddlCliente">Cliente</label>
                        <asp:DropDownList ID="ddlCliente" AppendDataBoundItems="true" runat="server" class="form-control req">
                            <asp:ListItem Text="Selecione..." Value="0" Selected="True" />
                        </asp:DropDownList>
                    </div>
                    <div class="col-sm-4">
                        <label for="ddlStatus">Status</label>
                        <asp:DropDownList ID="ddlStatus" AppendDataBoundItems="true" runat="server" class="form-control req">
                            <asp:ListItem Text="Selecione..." Value="0" Selected="True" />
