...
namespace AlphaCorp
{
    public partial class Cliente : System.Web.UI.Page
    {
        ...
        public static bool EditarErroCliente = false;
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (EditarErroCliente == true)
                {
                    try
                    {
                        EditarErroCliente = false;
                        modal.Notify.mNotify.Erro("Erro", "Cliente ja existente", this);
                    }
                    catch (Exception)
                    {
